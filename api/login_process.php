...
if ($username === '' || $password === '') {
    ...
    header('Location: ../login/login.html?error=' . urlencode('Please fill all required fields.'));
    exit;
}
...
if (!$user || !password_verify($password, $user['password_hash'])) {
    ...
    header('Location: ../login/login.html?error=' . urlencode('Invalid username or password. Please try again.'));
    exit;
}
